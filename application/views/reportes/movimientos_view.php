...
*/
  ...
  $("#jqGrid").jqGrid({
    url: 'get_movimientos',//'<?php echo base_url();?>jsonjqgrid.json',
...
*/
  ...
  function download_excel(){
    location.href="<?php echo base_url().'index.php/stock/excel_movimientos';?>"+"?id_deposito="+$("#id_deposito").val()+"&FechaInicio="+$("#FechaInicio").val()+"&FechaFin="+$("#FechaFin").val();
  }

  function print_movimientos(){
    //alert('remito');
    window.open('<?php echo base_url()?>index.php/stock/pdf_movimientos'+'?id_deposito='+$('#id_deposito').val()+'&FechaInicio='+$('#FechaInicio').val()+'&FechaFin='+$('#FechaFin').val(),'Imprimir','status=no,toolbar=no,resizable=yes,scrollbars=yes,width=535,height=400,left=300,top=200');
  ...
  <div class="ui-widget-header" style="padding-left: 1em"><?php echo $app; ?></div>
	<div>
	    <ul id="iconstool" class="ui-widget ui-helper-clearfix ui-state-default" style="margin:0px 0px 3px -40px;">
          ...
          <a href="<?php echo base_url().'index.php/stock/rep_movimiento'; ?>">
