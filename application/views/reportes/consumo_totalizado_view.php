...
*/
  ...
  $("#jqGrid").jqGrid({
    url: 'get_consumo_totalizado',//'<?php echo base_url();?>jsonjqgrid.json',
...
*/
  ...
  function download_excel(){
    location.href="<?php echo base_url().'index.php/stock/excel_consumo_totalizado';?>"+"?id_deposito="+$("#id_deposito").val()+"&FechaInicio="+$("#FechaInicio").val()+"&FechaFin="+$("#FechaFin").val();
  }


  function print_consumo_ctro_cto(){
    //alert('remito');
    window.open('<?php echo base_url()?>index.php/stock/print_consumo_totalizado?id_deposito='+$("#id_deposito").val()+'&FechaInicio='+$("#FechaInicio").val()+'&FechaFin='+$("#FechaFin").val(),'Imprimir','status=no,toolbar=no,resizable=yes,scrollbars=yes,width=535,height=400,left=300,top=200');
