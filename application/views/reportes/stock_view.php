...
*/
  $("#jqGrid").jqGrid({
    url: 'get_stock_deposito',//'<?php echo base_url();?>jsonjqgrid.json',
...
*/
  ...
  function download_excel(){
    location.href="<?php echo base_url().'index.php/stock/excel_stock';?>"+"?id_deposito="+$("#id_deposito").val();
  }

  function print_stock(){

    window.open('<?php echo base_url()?>index.php/stock/pdf_stock'+'?id_deposito='+$('#id_deposito').val(),'Imprimir','status=no,toolbar=no,resizable=yes,scrollbars=yes,width=535,height=400,left=300,top=200');
  ...
  <div class="ui-widget-header" style="padding-left: 1em"><?php echo $app; ?></div>
	<div>
	    <ul id="iconstool" class="ui-widget ui-helper-clearfix ui-state-default" style="margin:0px 0px 3px -40px;">
          ...
          <a href="<?php echo base_url().'index.php/stock/rep_stock_deposito'; ?>">
