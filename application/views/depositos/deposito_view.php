...
<script type="text/javascript"> 
    ...
    var template = "<div style='margin-left:15px;'><div>id_deposito<sup>*</sup>:</div><div> {id_deposito} </div>";
    ...
    $('#jqGridVale').jqGrid('setGridParam',{ url: 'deposito/lista_deposito',datatype: 'json' }).trigger("reloadGrid");
    }
