...
//--------------------------------
    $("#Buscar").click(function(){
      $("#lista").hide();
      $("#lista").load("<?php echo base_url();?>index.php/solicitudes/lista_solicitudes_web");
      $("#lista").dialog({
          modal: true,
          height: 550,
          width: 900,
      ...
      $.post('get_pedido_web',
        ...
        function(returnedData){
          ...
          if(returnedData[0]['nro']=="ERROR"){
            msg=returnedData[0]['msg']+": "+$("#nro").val();
...
//=========================================================
  ...
  function Limpiar_Form(){
    ...
    $("#centro_costo").autocomplete({
      source: "<?php echo base_url();?>index.php/contable/get_centro_costo", // path to the get_birds method
        minLength: 2,
    ...
    $("#denominacion").autocomplete({
      source: "<?php echo base_url();?>index.php/contable/get_denominacion_centro_costo", // path to the get_birds method
        minLength: 2,
      focus: function( event, ui ) {
...
//========================================================
    ...
    $("#material").autocomplete({
      source: function(request, response) {
        $.ajax({
              url: "<?php echo base_url();?>index.php/solicitudes/get_disponible",
                 dataType: "json",
              data: {
                term : request.term,
...
//=========================================================
    ...
    $("#zona").autocomplete({
      source: function(request, response) {
        $.ajax({
              url: "<?php echo base_url();?>index.php/solicitudes/get_zona",
                 dataType: "json",
              data: {
                term : request.term
                //id_deposito : $('#id_deposito').val()
    ...
    $("#localidad").autocomplete({
      source: "<?php echo base_url();?>index.php/solicitudes/get_localidad", // path to the get_birds method
        minLength: 2,
      focus: function( event, ui ) {
    ...
    $("#id_material").blur(
      function(){
        if(($("#id_material").val()!="")&&($("#id_deposito").val()!="")) {
            $.ajax({
               url: '<?php echo base_url();?>index.php/solicitudes/get_cod_disponible',
               data: {
    ...
    $("#barcode").blur(
      function(){
        if(($("#barcode").val()!="")&&($("#id_deposito").val()!="")) {
            $.ajax({
               url: '<?php echo base_url();?>index.php/solicitudes/get_barcode_disponible',
               data: {
                barcode : $('#barcode').val(),
                id_deposito : $('#id_deposito').val()
              },
       ...
       var template = "<div style='margin-left:15px;'><div>Codigo<sup>*</sup>:</div><div> {barcode} </div>";
        ...
        $(document).ready(function () {
            $("#jqGrid").jqGrid({
                ...
                caption: "Material Solicitado",pager: "#jqGridPager",
...
//======================================================
     if(parseFloat($( "#cantidad" ).val())>parseFloat($( "#cant_stock" ).val())){
        var msg="La cantidad a despachar es mayor a la existente "+" Existente:"+$("#cant_stock" ).val();
        $("#dialogo").removeClass();
        $("#dialogo").removeAttr();
        //var msg="<p><span class=\"ui-icon ui-icon-alert\" style=\"float:left;margin:0 7px 50px 0;\"></span></p><div>"+msg+"</div>";
...
/*
  ...
  function vale(nro,deposito){
    ...
    window.open('pedido_materiales?nros='+nro,'Imprimir','Imprimir','status=no,toolbar=no,resizable=yes,scrollbars=yes,width=535,height=300,left=200,top=300');
  }
...
//======================================================================
  function Enviar_Data(){
    ...
    if(gridData.length>0){
      ...
      $.post('<?php echo base_url();?>index.php/solicitudes/add_solicitud',
        data,
        function(returnedData){
          console.log(returnedData);
          //alert("Trajo data");
...
//===================================================
  function anular(nro){
      ...
      $.post('<?php echo base_url();?>index.php/solicitudes/anular_solicitud',
        data,
        function(returnedData){
          console.log(returnedData);
...
<body>
	...
	<div>
	    <ul id="iconstool" class="ui-widget ui-helper-clearfix ui-state-default" style="margin:0px 0px 3px -40px;">
	    	<li class="ui-state-default ui-corner-all" title="Solicitud de Material">
		        <a href="<?php echo base_url().'index.php/solicitudes/solicitudes_web'; ?>">
  ...
  <div class="linea">
    ...
    <div class="celda">
      <div><label class="etiqueta">Observaciones: </label></div>
    ...
    <div class="celda" style="visibility: hidden;">
      <div><label class="etiqueta">Solicitante: </label></div>
  ...
  <div class="linea">
	...
	<div class="linea" >
    <div class="ui-state-default ui-corner-all" style="margin-left: auto;margin-right: auto; min-height:4em; padding:auto;resize: none;overflow: visible;max-width: 85em">
      ...
      <div class="celda_body_short" style="visibility: hidden;">
  ...
  <div class="ui-corner-all" style="margin:3px; padding:10px 3px 10px 3px">
     <div style="margin: auto; width: 88em; height:3em; padding:0.4em">
      ...
      <div class="celda_body" style="float: right;margin: 3px;visibility: hidden;"><b>
