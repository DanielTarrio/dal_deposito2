...
//-------------------------------
    ...
    $("#nro").blur(function(){
      if($("#nro").val()!=""){
        ...
        $.post('<?php echo base_url();?>index.php/solicitudes/buscar_solicitud',
          data,
...
//=========================================================
    function trae_pedido(){
      ...
      $.post('<?php echo base_url();?>index.php/solicitudes/get_pedido_web',
        data,
        function(returnedData){
          console.log(returnedData);
        ...
        $(document).ready(function () {
            $("#jqGrid").jqGrid({
                ...
                ondblClickRow:function(rowid,iCol,cellcontent,e) {
                  //alert('cellcontent:' +cellcontent+' rowid: '+rowid+' iCol:'+iCol);
                  //edit_cantidad(rowidrowid);
                  alert(DatoCampo(rowid,'material'));
...
/*
  ...
  function DatoCampo(i,field){
    var gridData = jQuery("#jqGrid").getRowData();
    //console.log(gridData);
    var tmp="";
    tmp=gridData[i-1][field];
    return tmp;
  ...
  function editRow(id){
    ...
    if(id && id !== lastSelection){
      ...
      grid.jqGrid('editRow',id,{keys:true, focusField:12,extraparam:{id_detalle_pedido: DatoCampo(id,'id_detalle_pedido')},url:'set_solicitud_edit_web'});
      lastSelection=id;
    }
  }
...
/*
  ...
  function stock_disponible(value, colname){
    ...
    alert("value:"+value+"/n colname:"+colname);
    /*
...
<style>
 /*   body {
    ...
    .ui-icontool-siguiente { background-position: -256px -128px; }
    .ui-icontool-anterior { background-position: -256px -160px; }
...
<body>
	...
	<div>
	    <ul id="iconstool" class="ui-widget ui-helper-clearfix ui-state-default" style="margin:0px 0px 3px -40px;">
	    	<li class="ui-state-default ui-corner-all" title="Solicitud de Material">
		        <a href="<?php echo base_url().'index.php/solicitudes/solicitud_edit_web'; ?>">
        ...
        <li class="ui-state-default ui-corner-all" title="Registro anterior">
          <span id="RegAnt" class="ui-icontool ui-icontool-anterior"></span>
        </li>
  			<li class="ui-state-default ui-corner-all" title="Registro siguiente">
  				<span id="RegSig" class="ui-icontool ui-icontool-siguiente"></span>
  			</li>
  ...
  <div class="linea">
	...
	<div class="linea" style="visibility: hidden;">
    <div class="ui-state-default ui-corner-all" style="margin-left: auto;margin-right: auto; min-height:4em; padding:auto;resize: none;overflow: visible;max-width: 88em">
      <div class="celda_body">
