...
<script type="text/javascript"> 
        ...
        $("#jqGridVale").jqGrid({
            ...
            colModel: [
                ...
                },                   
                {
                    ...
                    editrules : { required: true},
                    edittype:"select",
                    editoptions:{value: ":<?php echo $centro_costo ?>"},
                    // stype defines the search type control - in this case HTML select (dropdownlist)
                    stype: "select",
                    // searchoptions value - name values pairs for the dropdown - they will appear as options
                    searchoptions: { value: ":[Todos]<?php echo $centro_costo ?>" }
                },
                {
					label: "Activo",
                    name: 'activo',
    ...
    function Refrescar(){
    $('#jqGridVale').jqGrid('setGridParam',{ url: 'lista_personal',datatype: 'json' }).trigger("reloadGrid");
    }
