...
<script type="text/javascript"> 
    ...
    var template = "<p><div style='margin-left:15px;'><div>Solo la descripcion es editable</div></div><br>";
        template += "<div> descripcion: </div><div>{descripcion} </div></p> ";
    ...
    $('#jqGridVale').jqGrid('setGridParam',{ url: 'lista_unidades',datatype: 'json' }).trigger("reloadGrid");
    }
